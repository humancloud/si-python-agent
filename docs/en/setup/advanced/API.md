# StackInsights Python Instrumentation API

Apart from the [supported libraries](../Plugins.md) that can be instrumented automatically, 
StackInsights also provides some APIs to enable manual instrumentation.
...
```python
from stackinsights import Component
from stackinsights.trace.context import SpanContext, get_context
...
from stackinsights import Component
from stackinsights.decorators import trace, runnable
from stackinsights.trace.context import SpanContext, get_context
...
with context.new_entry_span(op=str('https://github.com/apache/stackinsights')) as span:
    span.component = Component.Flask
    some_method()
```
