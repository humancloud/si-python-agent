...
from stackinsights.bootstrap.cli.utility import runner
...
def start() -> None:
    """ Entry point of CLI """
    parser = argparse.ArgumentParser(description='StackInsights Python Agent CLI',
                                     epilog='Append your command, with StackInsights agent attached for you automatically',
                                     allow_abbrev=False)
...
def dispatch(args: argparse.Namespace) -> None:
    ...
    cli_logger.debug(f"StackInsights Python agent with CLI option '{cli_option}' and command {actual_command}")
